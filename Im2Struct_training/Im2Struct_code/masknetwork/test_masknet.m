...
%加载测试数据
load('H:\matconvnet-1.0-beta24_20171026\matconvnet-1.0-beta24\masknetwork\data\imdb.mat');
...
im = imdb.images.data(:,:,:,2364);
rawim=bsxfun(@plus, im, net.meta.normalization.averageImage);
rawim=uint8(rawim);
%imshow(im);
c=imdb.images.labels(:,:,:,2364);
